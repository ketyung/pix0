...
export const MediaAttribRow : FC <Props> = ({
    index, attribute, setMediaAttributeAt
}) =>{

    return <div>
        <div className="inline-block mr-2">
            <TextField label="Attribute/Trait" className={commonTextfieldClassName("w-64")}
        ...
        <div className="inline-block mr-2">
            <TextField label="Display Type" className={commonTextfieldClassName("w-64")}
        ...
        <div className="inline-block mr-2">
            <TextField label="Value" className={commonTextfieldClassName("w-64")}
