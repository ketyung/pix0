...
export const Modal : FC <Props> = ({
    ...
    {showModal ? (
      <>
        <div id={id ?? "MyModal"} className="w-full md:w-9/12 lg:w-8/12 justify-center mx-auto items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
